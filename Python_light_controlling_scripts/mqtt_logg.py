...
client.subscribe("zigbee2mqtt/Ikea lampa 65543")
file.writelines("\n")
file.writelines("Prenumererar på topic: zigbee2mqtt/Ikea lampa 65543 \n" + "\n")


# Skriv till topic med olika payload
client.publish('zigbee2mqtt/Ikea lampa 65543/set','{ "state": "ON" }')
message_sent = 'zigbee2mqtt/Ikea lampa 65543/set','{ "state": "ON" }'
...
client.publish('zigbee2mqtt/Ikea lampa 65543/set','{ "state": "OFF" }')
message_sent = 'zigbee2mqtt/Ikea lampa 65543/set','{ "state": "OFF" }'
